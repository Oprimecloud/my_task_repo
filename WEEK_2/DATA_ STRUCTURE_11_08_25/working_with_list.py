...
# Method 1: Using square brackers
empty_list = []
...
print(squares) # Ouput: [0, 1, 4, 9, 16]
...
# Creating a Nested List. A list can contain others lists it is useful for matrics or grouped data.
# Matrix-like list
matrix = [[1, 2], [3, 4], [5,6]]
...
print(matrix[0][1])  # ouput: 2


# Characteristics of a list

# 1. Oredered Collection 
...
# 6 Daynamic size
# you don't need to declare the size of a list beforehand; it can grow or shrinkas needed.
